...
<!-- Sales Details -->
<div class="modal fade" id="details<?php echo $row['orderid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered" style="font-color: black;">
                        <thead>
                            <th>Product Name</th>
                            <th>Price</th>
                        ...
                        <tbody>
            <?php
            $sql="select * from purchase_detail left join product on product.productid=purchase_detail.productid where orderid='".$row['orderid']."'";
